# 📢 The "We Want" Demand Deck

### 🚩 Labor & Unions (Red)
1. [cite_start]"We want the expropriation of vacant luxury buildings"[cite: 1605, 2936].
2. [cite_start]"We want a 90% windfall tax on all banking profits"[cite: 1605, 2937].
3. [cite_start]"We want a permanent ban on all outsourcing and gig-work"[cite: 1606, 2938].
4. [cite_start]"We want state control of all strategic national industries"[cite: 1606, 2938].
...
2. [cite_start]"We want unconditional citizenship for all undocumented residents"[cite: 1609, 2942].
3. [cite_start]"We want the abolition of traditional police units"[cite: 1609, 2942].
4. [cite_start]"We want mandatory gender and racial quotas in all hiring"[cite: 1609, 2943].
...
2. [cite_start]"We want a permanent ban on short-haul domestic flights"[cite: 1611, 2946].
3. [cite_start]"We want meat and dairy taxed as luxury harmful goods"[cite: 1612, 2947].
4. [cite_start]"We want private land seized for mandatory nature corridors"[cite: 1612, 2948].
...
2. [cite_start]"We want the minimum wage abolished for market flexibility"[cite: 1614, 2951].
3. [cite_start]"We want all state-owned lands sold to the highest bidder"[cite: 1615, 2952].
4. [cite_start]"We want welfare replaced with a single digital voucher"[cite: 1615, 2953].
...
2. [cite_start]"We want an amnesty for all high-yield pesticide use"[cite: 1618, 2957].
3. [cite_start]"We want Indigenous Reserves opened for mineral mining"[cite: 1618, 2957].
4. [cite_start]"We want total legal immunity for rural landowners"[cite: 1618, 2958].
...
2. [cite_start]"We want the criminal age lowered to 12 years old"[cite: 1620, 2962].
3. [cite_start]"We want full-spectrum facial recognition in all public spaces"[cite: 1621, 2963].
4. [cite_start]"We want extrajudicial raids authorized in conflict zones"[cite: 1621, 2963].
...
2. [cite_start]"We want mandatory religious education in all schools"[cite: 1623, 2967].
3. [cite_start]"We want all forms of abortion criminalized without exception"[cite: 1623, 2967].
4. [cite_start]"We want secular arts defunded to protect our heritage"[cite: 1624, 2968].
